...
/// <summary>
/// DSPN для экспорта (ZL_LIST)
/// </summary>
[XmlRoot("ZL_LIST")]
public class DspnExportDto
{
    [XmlElement("ZGLV")]
    public DspnExportHeader? Header { get; set; }

    [XmlElement("ZAP")]
    public List<DspnExportRecord>? Records { get; set; }
}

public class DspnExportHeader
{
    [XmlElement("VERSION")]
...
public class DspnExportRecord
{
    [XmlElement("N_ZAP")]
    public long NZap { get; set; }

    [XmlElement("PACIENT")]
    public DspnExportPacient? Pacient { get; set; }

    [XmlElement("PLAN")]
    public DspnExportPlan? Plan { get; set; }

    [XmlElement("INF")]
    public List<DspnExportInf>? InfRecords { get; set; }
}

public class DspnExportPacient
{
