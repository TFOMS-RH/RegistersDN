...
/// <summary>
/// GF — Результаты верификации ГИС ОМС
/// </summary>
[XmlRoot("DN")]
...
public class GfImportHeader
{
    ...
    public string? ValidatedEnpCount { get; set; }
}
...
public class GfImportRecord
{
    ...
    public string? GroupRhCode { get; set; }

    [XmlElement("GROUP_RH_DS")]
    public string? GroupRhDs { get; set; }

    [XmlElement("DN_PRVS")]
    public string? DnPrvs { get; set; }
    ...
    [XmlElement("DN_GIS")]
    public DnGisImportInfo? DnGis { get; set; }

    [XmlElement("DN_LIST")]
    public DnListImportResult? DnList { get; set; }

    [XmlElement("DN_PLAN")]
    public DnPlanImportResult? DnPlan { get; set; }
...
public class DnListImportResult
{
    [XmlElement("DN_LIST_PERIOD")]
    public string? DnListPeriodCode { get; set; }
...
public class DnPlanImportResult
{
    ...
    public string? DnPlanResultCode { get; set; }
